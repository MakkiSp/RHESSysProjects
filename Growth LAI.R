...
thin01=as.data.frame(first10year("sen3","sen7","sen11","sen15","sen19",2001))
thin01=diff(thin01)
...
colnames(thin)=c("base","base","base","base","base","base","thin95","thin95","thin95","thin95","thin95","thin95","thin75","thin75","thin75","thin75","thin75","thin75","thin50","thin50","thin50","thin50","thin50","thin50","thin25","thin25","thin25","thin25","thin25","thin25")

setwd("D:/arnas/out/Totales/")
write.table(thin,"10years_lai.csv",sep=";",dec=",",col.names = T,row.names = F)
...
setwd("D:/arnas/out/Totales/")
write.table(thin.warm,"10years_lai.warm.csv",sep=";",dec=",",col.names = T,row.names = F)
