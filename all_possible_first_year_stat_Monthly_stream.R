...
monthlystr=function(data){
  ...
  xx=data %>% group_by(date=floor_date(date, "month")) %>%
    summarize(stream=sum(streamflow))
  xx=as.data.frame(xx)
...
plot(base,type="l",ylim=c(0,40),xaxt = "n")
...
plot(base.warm,type="l",ylim=c(0,40),xaxt = "n")
axis(1, at=1:12, labels=c("Oct.","Nov.","Dec.","Jan.","Feb.","Mar.","Apr.","May.","Jun.","Jul.","Aug.","Sep."))
...
write.table(matrice,"Monthlystream.stat.firstyear.csv",sep=";",dec=",",col.names = T,row.names = F)
